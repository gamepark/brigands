...
type MoveView = Exclude<Move, RevealPartnersDistricts | DrawEvent | RevealKickOrNot | RevealGolds> | DrawEventView | PlacePartnerView | RevealPartnersDistrictsView | KickOrNotView | RevealKickOrNotView | RevealGoldsView
